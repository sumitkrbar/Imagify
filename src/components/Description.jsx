    ...
    justify-center my-24 p-6 md:px-28'>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>Easily bring your ideas to life with my free AI 
                    image generator. Whether you need stunning visuals or
                    unique imagery, this tool transforms your text into 
                    eye-catching iamges with just a few clicks. Imagine it,
                    describe it, and watch it come to life instantly.
                </p>
                <p className='text-gray-600'>
                    Simply type in a text prompt, and the AI will 
                    generate high-quality images in seconds. From product 
                    visuals to character designs and portraits, even 
